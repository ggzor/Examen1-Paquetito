...
public class App {
  public static void main(String[] args) {
   ...
   try{
    ...
    boolean salir = false;
    do {
      System.out.println("\n\nMenú: \nSeleccione una opción:\n" + "\t 1.-Buscar la información de un paciente por nombre.\n"
      ...
      //por fecha
        ...
        String fechaBuscada = opcion.nextLine();
        ArrayList<Nombre> encontrados = busqueda.buscarPorFechaConsultaDeterminada(fechaBuscada);
         
        if (encontrados.size() == 0){
          System.out.println("No acudieron pacientes en esa fecha.");
        }else{
